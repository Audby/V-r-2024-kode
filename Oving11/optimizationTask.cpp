...
void optimizationTask() {
    ...
    //Oppgave 3b) optimalisering av opprettelse av nullmatrise:
    
    std::vector<std::vector<double>> matrix(matrixSize, std::vector<double>(matrixSize, initValue));
